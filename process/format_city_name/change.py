...
csv_file = '/home/dolong/Documents/Code/DATN/process/spark/new_states.csv'
...
with open(csv_file, 'r', encoding='utf-8') as file:
    ...
    for row in rows:
        city_name = row[2]
        # sub_country = row[2] 
        # city_name = city_name.strip('"')  # Remove quotation marks if present
        row[2] = city_name + " province"
